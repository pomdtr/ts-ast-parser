import type { ClassLikeNode, InterfaceOrClassDeclaration, SymbolWithContext } from "./types.ts";
...
export function getInstanceMembers(node: InterfaceOrClassDeclaration, context: ProjectContext): SymbolWithContext[] {
