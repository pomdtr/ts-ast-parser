import type { NamedNodeName, SymbolWithLocation } from "./utils/types.ts";
import type { AnalyserDiagnostic } from "./analyser-diagnostic.ts";
...
export class ProjectContext {
    ...
    getLocation(nodeOrType: ts.Node | ts.Type): SymbolWithLocation {
        ...
        const path = sourceFile?.fileName ? this._system.normalizePath(this._system.realpath(sourceFile.fileName)) : "";
